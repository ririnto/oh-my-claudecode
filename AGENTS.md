...
| `agents/` | Markdown prompt templates for 32 agents | `agents/AGENTS.md` |
...
|------------------|---------------------|
| `agents/*.md` | `src/agents/definitions.ts`, `src/agents/index.ts` |
| `skills/*/README.md` | `commands/*.md` (mirror), `scripts/build-skill-bridge.mjs` |
| `commands/*.md` | `skills/*/README.md` (mirror) |
| `src/hooks/*` | `src/hooks/index.ts`, related skill/command |
...
| `agents/*.md` files | `agents/AGENTS.md` |
